...
public class Main {
    public static void main(String[] args) {
        ...
        Employer employer1 = new Employer(1, "Андрей", "Колесов", 27, 1000.40);
        Employer employer2 = new Employer(2, "Ирина", "Родникова", 32, 925.66);
        Employer employer3 = new Employer(3, "Кирилл", "Долгопрудный", 32, 1200.00);
        Employer employer4 = new Employer(4, "Марина", "Десятова", 25, 1000.40);
        Employer employer5 = new Employer(5, "Ольга", "Зайцева", 40, 930.80);
        Employer employer6 = new Employer(6, "Иван", "Шамякин", 25, 1115.00);
        Employer employer7 = new Employer(7, "Степан", "Кочкин", 36, 990.20);
        Employer employer8 = new Employer(8, "Мария", "Зайцева", 28, 1300.00);
        ...
        raiseSalaryForProfession(employee, 200, "qa");
    ...
    private static void raiseSalaryForProfession(Map<Employer, String> employees, int amountOfIncrease, String profession) {
        for (Map.Entry<Employer, String> entry : employees.entrySet()) {
            if (entry.getValue().equals(profession)) {
                ...
                System.out.println("сотрудник: " + emp + " старая зп: " + oldSalary + " новая зп: " + emp.getSalary());
